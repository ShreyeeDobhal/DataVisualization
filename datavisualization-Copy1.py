...
#Instead of plotting the population frequency distribution of the population for the 3 countries, *pandas* instead plotted 
#the population frequency distribution for the `years`.
